    ...
    try:
        ...
        if api_key and len(points) >= 2:
            ...
            response = requests.post(
                f"https://api.openrouteservice.org/v2/"
...
<kml xmlns="http://www.opengis.net/kml/2.2">
  <Document>
    ...
    <description><![CDATA[{route.description or route.short_description or ""}
    ]]></description>
    <Style id="routeStyle">
      <LineStyle>
    ...
    if request.method in ["POST", "PUT"]:
        try:
            ...
            if "audio_file" in request.FILES:
                ...
                point.audio_guide.save(
                    audio_file.name, ContentFile(audio_file.read()), save=True
                )
